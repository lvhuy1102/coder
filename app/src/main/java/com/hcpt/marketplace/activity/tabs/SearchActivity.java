...
import com.hcpt.marketplace.activity.SearchProductResultActivity;
import com.hcpt.marketplace.activity.SearchShopResultActivity;
import com.hcpt.marketplace.adapter.CategoryAdapter;
import com.hcpt.marketplace.adapter.CityAdapter;
...
import com.hcpt.marketplace.interfaces.IMaps;
...
import com.hcpt.marketplace.util.MapsUtil;
...
public class SearchActivity extends BaseActivity implements OnClickListener {
    ...
    private SettingPreferences currentPreferences;
...
//        }
    ...
    public void refreshContent() {
        if (sharedPref.isFirstOpenSearchScreen()) {
            setData();
            sharedPref.setFirstOpenSearchScreen(false);
        }
    }
    ...
    private void setData() {
        ...
        isSelectShop = currentPreferences.getType().equals(SettingPreferences.TYPE_SHOP);
        isOpen = currentPreferences.getStatus().equals(SettingPreferences.OPEN);
        ...
        if (!sharedPref.getCacheCities().isEmpty()) {
            ...
            ModelManager.getListCity(SearchActivity.this, true, new ModelManagerListener() {
                @Override

...
import com.hcpt.marketplace.fragment.BannerFragment;
...
import com.hcpt.marketplace.widget.CirclePageIndicator;
...
public class ProductDetailActivity extends BaseActivity implements OnClickListener {
    ...
    private AutoBgButton btnFavourite, btnShowComments;
    ...
    private void initUI() {
        ...
        btnFavourite = (AutoBgButton) findViewById(R.id.btnFavourite);
        btnShowComments = (AutoBgButton) findViewById(R.id.btnShowComments);
        //banner
